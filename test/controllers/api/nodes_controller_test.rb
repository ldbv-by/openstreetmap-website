  ...
  class NodesControllerTest < ActionDispatch::IntegrationTest
    ...
    def test_create
      with_request do |headers, changeset|
        ...
        assert_in_delta lat * 10000000000, node.latitude, 1, "saved node does not match requested latitude"
        assert_in_delta lon * 10000000000, node.longitude, 1, "saved node does not match requested longitude"
